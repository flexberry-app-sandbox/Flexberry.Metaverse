...
namespace TV.Metaverse
{
    ...
    public class PersonAccount : ICSSoft.STORMNET.DataObject
    {
        ...
        private TV.Metaverse.SocialNetwork fSocialNetwork;
        ...
        [PropertyStorage(new string[] {
                "SocialNetwork"})]
        [NotNull()]
        public virtual TV.Metaverse.SocialNetwork SocialNetwork
        {
            get
            {
                ...
                TV.Metaverse.SocialNetwork result = this.fSocialNetwork;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку TV.Metaverse.Person.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PersonAccountE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PersonAccountE", typeof(TV.Metaverse.PersonAccount));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPersonAccount : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (TV.Metaverse.DetailArrayOfPersonAccount members)

        // *** End programmer edit section *** (TV.Metaverse.DetailArrayOfPersonAccount members)
        ...
        /// </summary>
        public DetailArrayOfPersonAccount(TV.Metaverse.Person fPerson) : 
                base(typeof(PersonAccount), ((ICSSoft.STORMNET.DataObject)(fPerson)))
        {
        }
        
        public TV.Metaverse.PersonAccount this[int index]
        {
            get
            {
                return ((TV.Metaverse.PersonAccount)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(TV.Metaverse.PersonAccount dataobject)
        {
