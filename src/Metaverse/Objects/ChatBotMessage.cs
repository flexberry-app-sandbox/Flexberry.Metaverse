...
namespace TV.Metaverse
{
    ...
    public class ChatBotMessage : ICSSoft.STORMNET.DataObject
    {
        ...
        private TV.Metaverse.ChatMessageType fChatMessageType;
        ...
        public virtual TV.Metaverse.ChatMessageType ChatMessageType
        {
            get
            {
                ...
                TV.Metaverse.ChatMessageType result = this.fChatMessageType;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ChatBotMessageE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ChatBotMessageE", typeof(TV.Metaverse.ChatBotMessage));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ChatBotMessageL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ChatBotMessageL", typeof(TV.Metaverse.ChatBotMessage));
                }
            }
        }
    }
